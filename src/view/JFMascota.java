...
public class JFMascota extends javax.swing.JFrame {
    ...
    void listar(){
        imprimir();
        if (m.tamaño()>0) {
            imprimir("codigo \t Raza \t\t Peso \t Nro. de vacunas");
            for (int i = 0; i < m.tamaño(); i++) {
                Mascota masco=m.obtener(i);
                imprimir(masco.getCodigo()+"\t"+masco.getRaza()+"\t\t"+
    ...
    void ingresar(){
        ...
        if (masco==null) {
            masco = new Mascota(getCodigo(),getRaza(),getPeso(),getNumeroVacunas());
            m.adicionar(masco);
            listar();
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(txtNumero, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE))
